    ...
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Import reviews from a CSV file (Judge.me format)
          </p>
        </div>
        <Link
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <p className="text-xs text-blue-600 mt-2">
          Judge.me exports are supported directly. Duplicates (same email +
          same text) are automatically skipped.
        </p>
      </div>
      ...
      <form onSubmit={handleImport} className="bg-white rounded-lg border border-gray-200 p-6 space-y-4">
        ...
        <div>
          ...
          >
            <option value="approved">Approved (recommended for Judge.me exports)</option>
      ...
      {result && (
        <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-3">
          <h3 className="text-lg font-medium text-gray-900">Import Result</h3>
